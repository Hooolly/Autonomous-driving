...
control::control()
{
    ...
    wii_communication_bool= nh_.subscribe<std_msgs::Bool>("manual",1000,&control::wiiCommunicationBoolCallback,this);


    cmd_linearVelocity = 0;
    cmd_angularVelocity = 0;
    cmd_steeringAngle = 1500;
...
void control::odomCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
    ...
    //odom_steeringAngle = 1500 - 500/30*odom_steeringAngle; //changed by group 3
...
void control::cmdCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
    ...
    //cmd_steeringAngle = 1500 - 500/30*cmd_steeringAngle; //changed by group 3
...
void control::wiiCommunicationBoolCallback(const std_msgs::Bool msg)
{


    control_Mode.data = msg.data;
